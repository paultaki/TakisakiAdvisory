@echo off
echo Setting up a new React app with Tailwind CSS...

cd /d C:\Users\pault\Documents\WebDevelopment\TheCriticalFew
echo Creating the React app...
call npx create-react-app timeline-app
...
echo Creating the App.js file with timeline component...
...
echo 1. Navigate to the project folder: cd C:\Users\pault\Documents\WebDevelopment\TheCriticalFew\timeline-app
echo 2. Run the development server: npm start
pause